(function () {
  ...
  function clearMemory() {
    ...
    if (messages) { messages.innerHTML = ""; addMessage(state.awaitingName ? copy[language()].askName : copy[language()].opening, "assistant", [], true); }
  }
  ...
  enhancedStyles.textContent = `
    ...
    .mansam-chat__header-mark{flex:0 0 auto;width:36px;height:36px;border:1px solid #d5b568;border-radius:50%;color:#f8e6b4;font-size:16px}
